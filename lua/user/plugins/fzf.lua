return {
  ...
  keys = {
    ...
    { "<leader>fD", "<cmd>FzfLua lsp_document_diagnostics<CR>", desc = "Document diagnostics (FZF)" },
    { "<leader>fs", "<cmd>FzfLua lsp_document_symbols<CR>",     desc = "Document symbols (FZF)" },
    { "<leader>fS", "<cmd>FzfLua lsp_workspace_symbols<CR>",    desc = "Workspace symbols (FZF)" },
  }
}
